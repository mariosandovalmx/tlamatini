...
*Tambien nos interesa saber cómo se relacionan la variables peso con nuestra variable de respuesta, la longitud hocico cloaca. Para ello usamos la función ggpairs_dfnum, que nos da el valor de correlación y el valor de p:*
...
*Podemos ajustar un modelo lineal generalizado (GLM). Con esta base de datos vamos a ajustar dos modelos lineales generalizados, el primero con la distribucion gaussiana y logaritmo como funcion de liga. El segundo con distribucion gaussiana y funcion de liga identity. Usaremos el la longitud hocico-cloaca como variable de respuesta. Además usaremos la variable Velocidad y Localidad como variables explicativas.*
...
**Para citar este paquete: Mario A. Sandoval-Molina (2021). tlamatini: Funciones utiles para biologxs y ecologxs confundidos con los modelos lineales. R package version 0.1.**
